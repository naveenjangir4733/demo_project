      ...
      {/* <div className="p-2 bg-gradient-to-b from-white to-yellow-100">
        ...
        <div className="flex  mt-6">
          ...
          <div>
            ...
            <div>
              <ul class="list-disc pl-9 mt-3 font-semibold font-mono  leading-5">
                <li>
        ...
        <div className=" flex flex-col items-center">
          ...
          <div className="flex flex-col items-center my-4">
            <div class="flex items-center">
              <span class="mx-2 font-semibold font-mono uppercase text-sm">
                chemicals & process
              </span>
              <div class="border-l border-solid border-red-600 h-4"></div>
              <span class="mx-2 font-semibold font-mono uppercase text-sm">power</span>
              <div class="border-l border-solid border-red-600 h-4"></div>
              <span class="mx-2 font-semibold font-mono uppercase text-sm">
                water & waste water
              </span>
              ...
              <div class="border-l border-solid border-red-600 h-4"></div>
              <span class="mx-2 font-semibold font-mono uppercase text-sm">Pharma</span>
              <div class="border-l border-solid border-red-600 h-4"></div>
              <span class="mx-2 font-semibold font-mono uppercase text-sm">
                sugar & Distillers
              </span>
            ...
            <div class="flex items-center">
              ...
              <div class="border-l border-solid border-red-600 h-4"></div>
              <span class="mx-2 font-semibold font-mono uppercase text-sm">solar</span>
              <div class="border-l border-solid border-red-600 h-4"></div>
              <span class="mx-2 font-semibold font-mono uppercase text-sm">building</span>
              <div class="border-l border-solid border-red-600 h-4"></div>
              <span class="mx-2 font-semibold font-mono uppercase text-sm">hvac</span>
              <div class="border-l border-solid border-red-600 h-4"></div>
              <span class="mx-2 font-semibold font-mono uppercase text-sm">
                fire fighting
              </span>
        ...
        {/* <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-center my-4">
            <div class="flex flex-wrap items-center ">
              <div class="flex flex-wrap items-center">
                <span class="mx-2 my-1 font-semibold font-mono uppercase text-sm">
                  Chemicals & Process
                </span>
                <div class="border-l border-solid border-red-600 h-4"></div>
              </div>
